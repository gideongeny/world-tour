...
def seed_db():
    ...
    try:
        ...
        destinations = [
            ...
            Destination(name='Zanzibar', country='Tanzania', description='Exotic spice island with pristine white sands. Rated 4.8/5 for relaxation.', price=280, rating=4.8, duration=7, image_url='https://images.unsplash.com/photo-1540656554792-7411bb583321?auto=format&fit=crop&q=80', category='beach', latitude=-6.1659, longitude=39.2026, climate='Tropical', best_time_to_visit='June to October', quote="The ocean stirs the heart, inspires the imagination and brings eternal joy to the soul. — Wyland"),
            ...
            Destination(name='Shanghai', country='China', description='The Pearl of the Orient. Rated 4.7/5 for modern wonders.', price=280, rating=4.7, duration=5, image_url='https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&q=80', category='city', latitude=31.2304, longitude=121.4737, climate='Subtropical', best_time_to_visit='Fall', quote="Shanghai is a city where every street corner has a story."),
            ...
            Destination(name='Dakar', country='Senegal', description='Gateway to Africa. Rated 4.5/5 for vibrance.', price=160, rating=4.5, duration=5, image_url='https://images.unsplash.com/photo-1627916607066-6b2dc504ea88?auto=format&fit=crop&q=80', category='cultural', latitude=14.7167, longitude=-17.4677, climate='Semi-arid', best_time_to_visit='Dry Season', quote="Dakar is a city of rhythm and color."),
