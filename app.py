...
def seed_db():
    ...
    try:
        ...
        destinations = [
            ...
            Destination(name='Zanzibar', country='Tanzania', description='Exotic spice island with pristine white sands. Rated 4.8/5 for relaxation.', price=280, rating=4.8, duration=7, image_url='https://images.unsplash.com/photo-1539651044670-315229da9d2f?auto=format&fit=crop&q=80', category='beach', latitude=-6.1659, longitude=39.2026, climate='Tropical', best_time_to_visit='June to October', quote="The ocean stirs the heart, inspires the imagination and brings eternal joy to the soul. — Wyland"),
            ...
            Destination(name='Dakar', country='Senegal', description='Gateway to Africa. Rated 4.5/5 for vibrance.', price=160, rating=4.5, duration=5, image_url='https://images.unsplash.com/photo-1543886481-c75c589df2eb?auto=format&fit=crop&q=80', category='cultural', latitude=14.7167, longitude=-17.4677, climate='Semi-arid', best_time_to_visit='Dry Season', quote="Dakar is a city of rhythm and color."),
