...
function GalleryScene({
    ...
    const handleWheel = useCallback(
        (event: WheelEvent) => {
            ...
            // For now, let's not prevent default to allow page scrolling
    ...
    useEffect(() => {
        // Event listener on window/document rather than just canvas needed for some interactions
        // But in a real app better to attach to container
        // Document listener removed to avoid hijacking global scroll
        return () => {
        };
    ...
    return (
        <>
            {planesData.current.map((plane, i) => {
                ...
                const aspect = (texture.image as HTMLImageElement)
